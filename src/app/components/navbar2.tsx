                  ...
                  {link.dropdown ? (
                    <div>
                      <button
                        ...
                        className='text-gray-600 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
              ...
              <div key={link.id}>
                {link.dropdown ? (
                  <div>
                    <button
                      onClick={toggleDropdown}
                      className='w-full text-left text-gray-600 hover:text-gray-900 block px-3 py-2 rounded-md text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                      aria-expanded={isDropdownOpen}
                      aria-haspopup='true'
                    >
                      {link.name}
